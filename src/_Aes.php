...
class _Aes
{
    ...
    public static function encode($data, $k32, $i16)
    {
        ...
        return \Junyang7\PhpCommon\_Base64::encode($res);
    ...
    public static function get()
    {
        ...
        $res = [];
        $res["k32"] = \Junyang7\PhpCommon\_RandomString::get(32, "0123456789qwertyuiopasdfghjklzxcvbnm");
        $res["i16"] = \Junyang7\PhpCommon\_RandomString::get(16, "0123456789qwertyuiopasdfghjklzxcvbnm");
        return $res;
